            ...
            <div className="tab-inner">
                <div className="row">
                    <div className="col-lg-8">
                        ...
                        <p className="text-light-dark">Kindly pay a token fee to access our exlusive booking service.
                        ...
                        <form className="row mb-md-80">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label className="fs-14 text-custom-black fw-500">Nationality</label>
                            ...
                            <div className="col-12">
                                ...
                                <div className="form-group">
                                    <label className="custom-checkbox">
                                        ...
                                        By continuing, you agree to the<Link to="#">Terms and Conditions.</Link>
                                    </label>
                                </div>
                                <button type="submit" className="btn-first btn-submit">I want to pay service fee</button>
                            </div>
                        </form>
                    </div>
                                ...
                                <div className="need-help bx-wrapper padding-20">
                                    ...
                                    <ul className="custom">
                                        ...
                                        <li className="text-custom-blue fs-18">
                                            ...
                                            <Link to="#" className="text-light-dark fs-14">fastdrive@gmail.com</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
