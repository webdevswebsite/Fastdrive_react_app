    ...
    <Fragment>
      ...
      <div className="contact-us-page">
        <section className="container">
          <h1 className="use-color">Support & Resources </h1>
          <p className="subtext">
            No matter where you are, we would always be here for you! <br />
        ...
        <section className="contact-us-grid">
          ...
          <form onSubmit={onSubmit} className="contact-us-page-container">
            <input
              required
              onChange={(e) =>
                setFormValues({ ...formValues, name: e.target.values })
              }
            ...
            <input
              ...
              type="email"
              onChange={(e) =>
                setFormValues({ ...formValues, email: e.target.values })
              }
            ...
            <input
              ...
              required
              onChange={(e) =>
                setFormValues({ ...formValues, phoneNumber: e.target.values })
              }
            ...
            <textarea
              required
              onChange={(e) =>
                setFormValues({ ...formValues, message: e.target.values })
              }
          ...
          <div className="contact-us-icon-text-group-container contact-us-page-container">
            <div className="contact-us-icon-text-group">
              <figure>
                <img alt="mail icon" src="/assets/images/icon-mail.svg" />
              </figure>
              <div>
                <p className="text-group-header">Email </p>
                <p className="text-group-text">info@fastdrive.ng</p>
              </div>
            </div>
            <div className="contact-us-icon-text-group">
              <figure>
              ...
              <div>
                <p className="text-group-header">Our Office</p>
                <p className="text-group-text">
                  Block A15 Admiralty Way, Lekki Phase 1, <br /> Lagos Nigeria.
                </p>
              </div>
            </div>
          </div>
